...
- [x] **1.0.2 Release Housekeeping** (Wrixle)
  - Cleaned up QuestBoard — reset for 1.1 planning, archived 1.0 summary
  - Renamed 5 completed handoffs with `DONE_` prefix
  - Created `CHANGELOG.md` documenting 1.0.0, 1.0.1, 1.0.2 releases
  - Updated `README.md` with version badge and changelog link
  - Created `council/qa/README.md` index for QA artifacts
  - Project ready for 1.1 feature selection
